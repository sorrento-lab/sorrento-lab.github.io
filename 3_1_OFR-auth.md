...
| 77          | User class ID | `+FSVDSL_livebox.Internet.`  `softathome.Livebox4` |Livebox4 is shown also in Livebox5 models|Found via liveboxtools option 77 = `2b46535644534c5f6c`  `697665626f782e49`  `6e7465726e65742e736f6`  `6746174686f6d652e4`  `c697665626f7834` (in hex)|
